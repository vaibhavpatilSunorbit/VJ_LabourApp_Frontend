...
import LabourTableRow from './LabourTableRow';
            ...
            >
              ...
              {(rowsPerPage > 0
                ...
                <LabourTableRow
                  ...
                  user={user}
                  statuses={statuses}
                  statusesSite={statusesSite}
                  approvedLabours={approvedLabours}
                  approvingLabours={approvingLabours}
                  submittedLabourIds={submittedLabourIds}
                  selectedSite={selectedSite}
                  projectNames={projectNames}
                  getProjectDescription={getProjectDescription}
                  getDepartmentDescription={getDepartmentDescription}
                  handleDownloadPDF={handleDownloadPDF}
                  handleEditLabourOpen={handleEditLabourOpen}
                  handleResubmit={handleResubmit}
                  handleEdit={handleEdit}
                  handleApproveConfirmOpen={handleApproveConfirmOpen}
