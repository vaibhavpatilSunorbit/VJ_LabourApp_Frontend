...
const accessPages = ["Application", "Labour Details", "Add User", "Project Machine", "Attendance Report", "Wages Report", "People", "Admin Approval", "Site Transfer", "Variable Input"];
