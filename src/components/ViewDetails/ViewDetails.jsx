...
//     try {
//       const croppedImage = await getCroppedImg(modalImageSrc, croppedAreaPixels, rotation);
//       const link = document.createElement('a');
//       link.href = croppedImage;
//       link.download = 'cropped_doc.jpg';
...
//               />
//               <Box sx={{ mt: 2 }}>
//                 <Button variant="contained" onClick={handleStartCrop}>
//                   Crop Image
//                 </Button>
//               </Box>
//             </>
...
//                 <Button variant="contained" color="success" onClick={handleSaveCroppedImage}>
//                   Save Cropped
//                 </Button>
//                 <Button variant="outlined" color="error" onClick={() => setIsCropping(false)}>
//                   Cancel
//                 </Button>
//               </Box>
//             </Box>
