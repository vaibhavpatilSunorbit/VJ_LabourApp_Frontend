...
//   //               localError = 'The same Aadhaar card number back photo is uploaded.';
...
if (!localError) {
  ...
  const validateForm = () => {
    const requiredFields = [
      'uploadAadhaarFront', 'labourOwnership', 'title', 'name', 'aadhaarNumber', 'dateOfBirth', 'contactNumber', 'gender', 'uploadIdProof',
...
//   };
  ...
  //   return project ? project.Business_Unit : projectId;
  // };
  //   const getDepartmentDescription = (departmentId) => {
  //   const department = departments.find((dept) => dept.Id === departmentId);
  //   return department ? department.Description : departmentId;
  // };
  ...
  //   const transformedData = transformDataForPreview(processedData);
